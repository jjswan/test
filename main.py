...
def main():
    ...
    st.set_page_config(page_title="장지윤 test", page_icon="🥨")  # 웹 페이지 제목과 아이콘 설정
    st.image('economy.png')  # 상단에 이미지를 표시
    st.title("_:blue[4학년 경제적 교류 학습 도우미]_ 🏫")  # 제목 표시 (에너지 학습 도우미)
    st.header("챗봇을 사용해보세요!", divider='rainbow')  # 주의사항 표시
